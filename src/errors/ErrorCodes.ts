...
export const ErrorCode = {
    ...
    INVALID_PROFILE_MODE: "err_invalid_profile_mode",
    ...
    CONTRACT_REQUEST_FAILED: "err_contract_request_failed",
    PROFILE_RELATIONSHIP_NOT_FOUND: "err_profile_relationship_not_found",
